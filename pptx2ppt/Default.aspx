...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h1 style="display:none;">PPT to PPTX converter</h1>
    ...
    <asp:Label ID="lblDebug" runat="server" Text="" Style="display:block; margin:1ex 0; padding:0.25em; font-family:monospace; white-space:pre; overflow:visible; _border:1px solid #808080; _background-color:#FFFFCC;"></asp:Label>
</asp:Content>
